    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-join-computational-optimization-methods-comet-lab-as-an-undergraduate-researcher",
          title: 'Join Computational Optimization Methods (COMET) Lab as an Undergraduate Researcher.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%68.%6C%65%65@%6B%61%69%73%74.%61%63.%6B%72", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jaehwanlee-878400314", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=sIbRfHgAAAAJ", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0003-9985-7118", "_blank");
        },
      },{
      id: 'light-theme',
